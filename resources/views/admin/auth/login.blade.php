    ...
    <style media="screen">
        ...
        *:after{
        ...
        form{
            ...
            border: 5px solid #67b7dd;
            box-shadow: 0 0 139px #1299da;
            padding: 10px 35px;
        }
        form *{
...
<body style="background: url({{ settings('login_bg_image') ? settings('login_bg_image') : '' }}); background-repeat: no-repeat; background-size: cover;">
<div id="app">
