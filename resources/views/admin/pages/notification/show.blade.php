                ...
                <div class="card-body py-sm-4">
                    ...
                    <div class="text-center mt-4 nav-tab">
                        ...
                        <button class="btn btn-sm btn-danger mb-2"
                            onclick="confirmFormModal('{{ route('admin.notification.delete.api', $notification->id) }}?page={{ request()->query('page', 1) }}', 'Confirmation', 'Are you sure to delete operation?')"><i
