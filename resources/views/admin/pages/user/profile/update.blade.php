                ...
                <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group @error('user.nick_name') error @enderror">
                                                <input type="text" class="form-control" name="user[nick_name]"
                                                    ...
                                                    placeholder="{{ __('Preferred Name (optional)') }}">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="p-sm-3">
                            ...
                            <div class="form-group row @error('user.ethnicity') error @enderror">
                                <label class="col-sm-3 col-form-label required"
                                    for="name">{{ __('Ethnicity') }}</label>
                                <div class="col-sm-9">

                                    <select class="select form-control" name="user[ethnicity]"
                                        id="ethnicity" style="width: 100%;" required>
                                        <option value="" selected disabled>Select One</option>
                                        @foreach ($ethnicities as $ethnicity)
                                            <option value="{{ $ethnicity }}"
                                                {{ old('user.ethnicity', $user->ethnicity) == $ethnicity ? 'selected' : '' }}
                                                data-params="{{ $ethnicity }}">
                                                {{ $ethnicity }}</option>
                                        @endforeach
                                    </select>
                                    @error('user.ethnicity')
                                        <p class="error-message">{{ $message }}</p>
                                    @enderror
                                </div>
                            </div>
