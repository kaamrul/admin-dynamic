...
<div class="content-wrapper">
    ...
    <div class="card shadow-sm">
        <div class="card-body py-sm-4">
            <form method="post" action="{{ route('admin.user.employee.store') }}" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div
                                                class="form-group @error('password') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control select2" name="gender" id="gender">
                                        ...
                                        @foreach($genders as $gender)
                                            <option class="text-capitalize" value="{{ $gender }}" {{ (old("gender") == $gender) ? "selected" : "" }}>
                                                {{ $gender }}</option>
                                        @endforeach
                                    </select>
                                    @error('gender')
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control select2" name="designation" id="designation">
                                        ...
                                        @foreach($designations as $designation)
                                            <option class="text-capitalize" value="{{ $designation }}" {{ (old("designation") == $designation) ? "selected" : "" }}>
                                                {{ $designation }}</option>
                                        @endforeach
                                    </select>
                                    @error('designation')
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control select2" name="territory_id" id="territoryId">
                                        ...
                                        @foreach($territories as $territory)
                                            <option class="text-capitalize" value="{{ $territory->id }}" {{ (old("territory_id") == $territory->id) ? "selected" : "" }}>
                            ...
                            <div class="form-group row @error('van_id') error @enderror">
                                ...
                                <div class="col-sm-9"> 
                                    <select class="form-control select2" name="van_id[]" id="vanId" multiple>
                                        <option value="" class="selected highlighted">Select One</option>
                                        @foreach($vans as $van)
                                            <option class="text-capitalize" value="{{ $van->id }}" {{ (collect(old("van_id"))->contains($van->id)) ? "selected" : "" }}>
                            ...
                            <div class="form-group row @error('driving_license') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="driving_license"
                                        value="{{ old('driving_license') }}" placeholder="{{ __('Driving License') }}">
                            ...
                            <div class="form-group row @error('description') error @enderror">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" rows="3"
                                        name="description" placeholder="Write here description....">{{ old('description') }}</textarea>
