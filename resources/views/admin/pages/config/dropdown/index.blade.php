                                     ...
                                     <div class="action dropdown">
                                         ...
                                         <div class="dropdown-menu">
                                            ...
                                            @if(Helper::hasAuthRolePermission('dropdown_delete'))
                                                <a class="dropdown-item text-danger" href="javascript:void(0)" onclick="confirmModal(deleteDropdown, '{{ $key }}', 'Are you sure you want to delete this record?')" ><i class="far fa-trash-alt"></i> Delete</a>
                                            @endif
                                         </div>
                                     </div>
                                 </td>
