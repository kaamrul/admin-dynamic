...
<div class="row">
    <div class="col-md-12 content-area pt-3">
        ...
        <form method="post" action="{{ route('member.dashboard.boat.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div>
                        ...
                        {{-- <div class="form-group row @error('registration_number') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="registration_number"
                                    value="{{ old('registration_number') }}" placeholder="{{ __('Registration Number') }}"
                                    required>
                            ...
                            <div class="col-sm-9">
                                <select class="form-control select2" name="skipper_id" id="skipper_id" required>
                                    ...
                                    <option value="{{ $user->id }}" data-name="{{ $user->full_name }}"
                                        {{(old("skipper_id") == $user->id) ? "selected" : ""}}>
                        ...
                        <div class="form-group row @error('make') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="make"
                                    value="{{ old('make') }}" placeholder="{{ __('Make') }}">
                                @error('make')
                                <p class="error-message">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row @error('motor') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="motor"
                                    value="{{ old('motor') }}" placeholder="{{ __('Motor') }}">
                                @error('motor')
                                <p class="error-message">{{ $message }}</p>
                                @enderror
                            </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row @error('safety_equipment') error @enderror">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="safety_equipment"
                                value="{{ old('safety_equipment') }}" placeholder="{{ __('Safety Equipment') }}">
                    ...
                    <div class="form-group row @error('call_sign') error @enderror">
                        <label class="col-sm-3 col-form-label">{{ __('Call Sign') }}</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="call_sign"
                                value="{{ old('call_sign') }}" placeholder="{{ __('Call Sign') }}">
                            @error('call_sign')
                            <p class="error-message">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    {{-- <div class="form-group row @error('note') error @enderror">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" rows="6" class="form-control" name="note"
                                placeholder="{{ __('Write Boat Note') }}">{{ old('note') }}</textarea>
                            @error('note')
                            <p class="error-message">{{ $message }}</p>
                            @enderror
                        </div>
