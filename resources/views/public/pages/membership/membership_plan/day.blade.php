...
<main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    {!! \App\Library\Html::breadcrumbsSection('Day Plan') !!}
    <!-- End Breadcrumbs -->
            ...
            <div class="row">
                ...
                <div class="col-11 col-sm-12 col-md-12 col-lg-6 col-xl-6 mt-1 mb-2">
                    ...
                    <div id="subscription" class="card px-5 pt-4 pb-1 mt-3 mb-3 shadow-sm main box-shadow-primary">
                        ...
                        {{-- <div class="p-sm-2">
                            <div class="form-group row @error('tournament_id') error @enderror">
                                <label class="col-sm-3 col-form-label required">{{ __('Select Tournament') }}</label>
                                <div class="col-sm-9">
                                    <select class="form-control" id="tournament_id" name="tournament_id" required>
                                        <option value=""></option>
                                    @foreach($tournaments as $key => $tournament)
                                        <option value="{{ $tournament->id }}" {{ old('tournament_id', $tournamentId??'') == $tournament->id ? 'selected' : '' }}>
