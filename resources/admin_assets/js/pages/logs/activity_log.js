    ...
    .then(response => {
        ...
        if (typeof(beforeData) == 'number') {
            ...
            beforeDataKey.forEach(function(beforeDataKey, index) {
                if (beforeDataKey == 'date' || beforeDataKey == 'created_at' || beforeDataKey == 'updated_at' || beforeDataKey == 'visiting_time' || beforeDataKey == 'sending_at' || beforeDataKey == 'send_date' || beforeDataKey == 'sending_date'|| beforeDataKey == 'purchase_date'|| beforeDataKey == 'warranty_date' || beforeDataKey == 'testing_date' || beforeDataKey == 'next_testing_date') {
                    if (beforeDataKey == 'sending_at' || beforeDataKey == 'send_date' || beforeDataKey == 'sending_date'|| beforeDataKey == 'purchase_date'|| beforeDataKey == 'warranty_date' || beforeDataKey == 'testing_date' || beforeDataKey == 'next_testing_date') {
