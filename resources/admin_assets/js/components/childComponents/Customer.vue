...
export default {
    ...
    methods: {
        ...
        async getCustomers() {
            await axios
                .get(
                    `${this.baseUrl}/store/pos/customers?per_page=${this.itemsPerPage}&page=${this.page}&search=${this.searchCustomer}`
                )
                .then((response) => {
        ...
        async addNewCustomer() {
            await axios
            .post(`${this.baseUrl}/store/pos/customer`, this.newCustomer)
            .then((response) => {
        ...
        async getDeuAmount() {
            await axios
                .get(
                    `${this.baseUrl}/store/pos/customers/${this.selectedCustomer.id}/due`
                )
                .then((response) => {
