...
window.catchNotify = function (message, type = 'success', callback = null) {
    new Swal({
        title: 'Please Wait...',
        ...
        timer: 3000,
        showConfirmButton: false,
        imageUrl: 'https://i.pinimg.com/originals/5f/55/c3/5f55c32914f6631a95eee13fb75a7748.gif',
    }).then((result) => {
...
function fileBrowse(event, parent_element)
{
    ...
    const image_extensions = ['jpg', 'jpeg', 'gif', 'png', 'webp'];
...
// Get Formatted Time
window.getFormattedTime = function (time) {
